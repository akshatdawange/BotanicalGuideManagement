  ...
  <div class="containerJumbo">
    ...
    <p class="lead">The Bryophyta s.l. are a proposed taxonomic division containing three groups of non-vascular land plants: the liverworts, hornworts and mosses.
      ...
      <table class="table table-borderless">
        ...
        {
          echo'<button class="btn btn-dark mx-1 my-3"><a href="adminBryophyta.php?page='.$btn.'">'.$btn.'</a></button>';
        }
        if(isset($_GET['page'])){
          $page=$_GET['page'];
        }
        ...
        while($rows=mysqli_fetch_assoc($result))
            {
              ...
              <td>'.$species. '</td>
              <td>'.$genus.' </td>
              <td> <button class= "btn btn-primary"><a class= "text-light" href="updateBryo.php?updateid='.$id.'">Update </a></button></td>
              <td><button class= "btn btn-danger"> <a href="deleteBryo.php?deleteid='.$id.'"  class="text-light">Delete </a></button>
