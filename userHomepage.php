    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="LoginPage.php">Logout</a>
          </li>
  ...
  <section class="my-5">
    <div class="container">
      ...
      <div class="card-columns">
        <div class="card ">
            ...
            <div class="card-body text-center">
              ...
              <a href="userAntho.php" class="btn btn-link">See Profile</a>
              <br>
              <?php
      ...
      <div class="card">
          ...
          <div class="card-body text-center">
            <p class="card-text">Bryophyta</p>
              <a href="userBryo.php" class="btn btn-link">See Profile</a>
              <br>
              <?php
      ...
      <div class="card">
          ...
          <div class="card-body text-center">
            <p class="card-text">Charophyta</p>
              <a href="userCharo.php" class="btn btn-link">See Profile</a>
              <br>
              <?php
      ...
      <div class="card">
          ...
          <div class="card-body text-center">
            <p class="card-text">Chlorophyta</p>
              <a href="userChloro.php" class="btn btn-link">See Profile</a>
              <br>
              <?php
      ...
      <div class="card">
        ...
        <div class="card-body text-center">
          <p class="card-text">Glaucophyta</p>
            <a href="userGlauco.php" class="btn btn-link">See Profile</a>
            <br>
            <?php
      ...
      <div class="card-body text-center">
        ...
        <a href="userMarchantio.php" class="btn btn-link">See Profile</a>
        <br>
        <?php
      ...
      <div class="card-body text-center">
        ...
        <a href="userRhodo.php" class="btn btn-link">See Profile</a>
        <br>
        <?php
