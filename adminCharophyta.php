  ...
  <div class="containerJumbo">
    ...
    <br><h5>Suitable Habitat:</h5>Quiet freshwater habitats such as ponds and streams; a few are found in brackish water.
      ...
      <table class="table table-borderless">
        ...
        {
          echo'<button class="btn btn-dark mx-1 my-3"><a href="adminCharophyta.php?page='.$btn.'">'.$btn.'</a></button>';
        }
        if(isset($_GET['page'])){
          $page=$_GET['page'];
        }
        ...
        while($rows=mysqli_fetch_assoc($result))
        {
          ...
          <td>'.$species. '</td>
          <td>'.$genus.' </td>
          <td> <button class= "btn btn-primary"><a class= "text-light" href="updateCharo.php?updateid='.$id.'">Update </a></button></td>
          <td><button class= "btn btn-danger"> <a href="deleteCharo.php?deleteid='.$id.'"  class="text-light">Delete </a></button>
