...
$id = $_GET['updateid'];
$auto = "SELECT * FROM `rhodophyta` WHERE speciesKey = $id";
...
if(isset($_POST['update'])){
    ...
    try{$sql = "UPDATE `rhodophyta` SET speciesKey = $id,family = '$family1',species = '$species1',genus = '$genus1' WHERE speciesKey = $id ";
    ...
    if($result){
        header('location: adminRhodophyta.php');
    }
}
?>
<!DOCTYPE html>
