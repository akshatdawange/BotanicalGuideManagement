...
$id = $_GET['updateid'];
$auto = "SELECT * FROM `bryophyta` WHERE speciesKey = $id";
...
if(isset($_POST['update'])){
    ...
    try{$sql = "UPDATE `bryophyta` SET speciesKey = $id,family = '$family1',species = '$species1',genus = '$genus1' WHERE speciesKey = $id ";
    ...
    if($result){
        header('location: adminBryophyta.php');
    }
}
?>
<!DOCTYPE html>
