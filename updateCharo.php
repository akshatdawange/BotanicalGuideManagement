...
$id = $_GET['updateid'];
$auto = "SELECT * FROM `charophyta` WHERE speciesKey = $id";
...
if(isset($_POST['update'])){
    ...
    try{$sql = "UPDATE `charophyta` SET speciesKey = $id,family = '$family1',species = '$species1',genus = '$genus1' WHERE speciesKey = $id ";
