...
$id = $_GET['updateid'];
$auto = "SELECT * FROM `chlorophyta` WHERE speciesKey = $id";
...
if(isset($_POST['update'])){
    ...
    try{$sql = "UPDATE `chlorophyta` SET speciesKey = $id,family = '$family1',species = '$species1',genus = '$genus1' WHERE speciesKey = $id ";
    ...
    if($result){
        header('location: adminChlorophyta.php');
    }
}
?>
<!DOCTYPE html>
